...
(function ($PS) {
  ...
  var toggleButton = function toggleButton(isOn) {
    ...
    return Halogen_HTML_Elements.button([Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Properties.class_("button"), Halogen_HTML_Events.onClick(function (v) {
      return new Data_Maybe.Just(Toggle.value);
    })])([Halogen_HTML_Core.text("The button is " + toggleLabel)]);
  };

  var stateAndActionCompontent = function stateAndActionCompontent(spec) {
    return Halogen_Component.mkComponent({
      initialState: Data_Function["const"](spec.initialState),
      render: spec.render,
      "eval": Halogen_Component.mkEval({
        handleAction: spec.handleAction,
  ...
  var runStateAndActionComponent = function runStateAndActionComponent(childSpec) {
    return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(stateAndActionCompontent(childSpec))(Data_Unit.unit)(body);
    }));
  };

  var handleAction = function handleAction(v) {
    return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (oldState) {
      var newState = !oldState;
      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newState);
    });
  };

  var main = runStateAndActionComponent({
    initialState: false,
    render: toggleButton,
  ...
  exports["main"] = main;
  exports["runStateAndActionComponent"] = runStateAndActionComponent;
  exports["stateAndActionCompontent"] = stateAndActionCompontent;
})(PS);
...
},{}]},{},["../../../../../Users/pietr/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","../dist/app.js"], null)
